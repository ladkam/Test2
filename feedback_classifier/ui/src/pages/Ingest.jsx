...
import { Upload, FileText, CheckCircle, AlertCircle, FileSpreadsheet, PenLine } from 'lucide-react'
...
export default function Ingest() {
  const [activeTab, setActiveTab] = useState('csv') // 'single' or 'csv'
      ...
      <div className="flex gap-4 mb-6">
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-sm opacity-75">Import multiple rows at once</p>
          </div>
        </button>
        <button
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-sm opacity-75">Add one feedback manually</p>
          </div>
        </button>
      </div>

      {/* CSV Upload Tab */}
      {activeTab === 'csv' && <CSVUpload onComplete={handleCSVComplete} />}
